package org.setareh.wadl.codegen.module.es6;
...
public class EcmaScript6ClientModule extends AbstractClientModule {

    @Override
    public ModuleName getName() {
        return ModuleName.ECMASCRIPT6;
    }
    ...
    public void init() throws ModuleException {
        classTemplate = this.getTemplateURL("es6-schemas-template.ftl");
    }
